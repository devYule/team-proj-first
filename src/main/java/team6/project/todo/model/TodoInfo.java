...
public class TodoInfo {
    ...
    public TodoInfo(Integer itodo, String todoContent, LocalDate startDate, LocalDate endDate, LocalTime startTime, LocalTime endTime) {
        this.itodo = itodo;
    ...
    public TodoInfo(Integer itodo, String todoContent, LocalDate startDate, LocalDate endDate, LocalTime startTime, LocalTime endTime, LocalDate repeatEndDate, String repeatType, Integer repeatNum) {
        this.itodo = itodo;
        this.todoContent = todoContent;
        this.startDate = startDate;
        this.endDate = endDate;
